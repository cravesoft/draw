...
{
	if(y > mediumStartY && y < mediumStartY + mediumImageHeight){
		curColor = colorPurple;
	}else if(y > mediumStartY + mediumImageHeight && y < mediumStartY + mediumImageHeight * 2){
		curColor = colorGreen;
	}else if(y > mediumStartY + mediumImageHeight * 2 && y < mediumStartY + mediumImageHeight * 3){
		curColor = colorYellow;
	}else if(y > mediumStartY + mediumImageHeight * 3 && y < mediumStartY + mediumImageHeight * 4){
		curColor = colorBrown;
	}
}

function changeCursorSize(x, y)
{
    var sizeHotspotStartX = drawingAreaX + drawingAreaWidth;
    if(y < sizeHotspotStartY + sizeHotspotHeight && x > sizeHotspotStartX)
    {
    	if(x < sizeHotspotStartX + sizeHotspotWidthObject.huge){
    		curSize = "huge";
    	}else if(x < sizeHotspotStartX + sizeHotspotWidthObject.large + sizeHotspotWidthObject.huge){
    		curSize = "large";
    	}else if(x < sizeHotspotStartX + sizeHotspotWidthObject.normal + sizeHotspotWidthObject.large + sizeHotspotWidthObject.huge){
    		curSize = "normal";
    	}else if(x < sizeHotspotStartX + sizeHotspotWidthObject.small + sizeHotspotWidthObject.normal + sizeHotspotWidthObject.large + sizeHotspotWidthObject.huge){
    		curSize = "small";						
    	}
    }
}

function changeTool(y)
{
    if(y < toolHotspotStartY + toolHotspotHeight){
    	curTool = "crayon";
    }else if(y < toolHotspotStartY + toolHotspotHeight * 2){
    	curTool = "marker";
    }else if(y < toolHotspotStartY + toolHotspotHeight * 3){
    	curTool = "eraser";
    }
}
